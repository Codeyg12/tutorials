<footer class="py-16 sm:py-20 md:py-24 px-4 md:px-8">
  ...
  >
    ...
    <div class="flex flex-col gap-4">
      ...
      <a
        href="https://www.google.com/search?q=science&rlz=1C1CHBF_enUS981US981&oq=science&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIGCAEQRRg8MgYIAhBFGD0yBggDEEUYPTIGCAQQRRg80gEIMjA3NmowajSoAgCwAgE&sourceid=chrome&ie=UTF-8"
        target="_blank"
        class="cursor-pointer hover:text-indigo-400 duration-200"
      >
        Read the science</a
